...
export default function ClassesList(){
            ...
            },
            {
                ...
                cell: ({ getValue }) => {
                  ...
                  return subjectName ? (
                    ...
                    <span className="text-muted-foreground"> No set </span>
                  )
                }
            }, 
            {
                ...
                cell: ({ getValue }) => {
                  ...
                  return teacherName ? (
                    ...
                    <span className="text-muted-foreground"> No assigned </span>
                  )
                }
            },
            {
    ...
    const { query: subjectsList } = useList<Subject>({
      resource: "subjects",
      pagination: {
        pageSize: 100,
      },
    ...
    const { query: teachersList} = useList<User>({
      resource: "users",
      pagination: {
        pageSize: 100,
      },
    ...
    const subjects = subjectsList.data?.data ?? [];
    const teachers = teachersList.data?.data ?? [];
